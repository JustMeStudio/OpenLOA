...
system_prompt = """你能根据用户的简历和用户对需求岗位的补充指示，前往BOSS直聘帮用户寻找匹配的岗位，并投递简历（向BOSS打招呼）
...
async def main():
    try:
        ...
        if language == "en":
            qprint(
                "Hi! I'm Sara, your personal job application assistant. I can help you find suitable job positions on Boss Zhipin(A Chinese job platform) and submit your resume to them.\n\n"
                "Here's how I work:\n"
                "1. I'll ask you to provide me with your resume file and any additional requirements you have for the job (e.g., salary, location, company size, etc.).\n"
                "2. Once I have all the necessary information, I'll ask for your confirmation before I start submitting your applications.\n"
                "3. After you confirm, I'll immediately start submitting your applications using my tools.\n"
                "4. Once the submission is complete, I'll report the results back to you and let you know that if Boss Zhipin is interested in you, they will reply to your message in the Boss Zhipin app. Please keep an eye on it! I wish you find a job you like soon!"
            )
        if language == "zh":
            qprint(
                "好运，不会眷顾傻瓜~"
                "我是<职位猎人-Sara>，我可以在BOSS直聘上为你寻找适合你的职位，并向BOSS打招呼（投递简历）：\n" \
                "1.你需要将以下文件/信息提供给我：\n"
